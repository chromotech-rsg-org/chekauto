...
export default function ClientData() {
  ...
  const handleBuscarCliente = async () => {
    if (!formData.cpfCnpj) {
      toast({ title: "CPF/CNPJ obrigatório", description: "Digite o CPF/CNPJ para buscar o cliente", variant: "destructive" });
      return;
    }
    ...
    try {
      ...
      if (data.found && data.cliente) {
        ...
        toast({ title: "Cliente não encontrado", description: "Preencha os dados manualmente" });
      }
    } catch (error) {
      console.error('Erro ao buscar cliente:', error);
      toast({ title: "Erro ao buscar cliente", description: "Continue preenchendo os dados manualmente", variant: "destructive" });
    } finally {
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          <div className="bg-white rounded-lg p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <FloatingLabelWrapper label="CPF/CNPJ" htmlFor="cpfCnpj">
                <div className="flex gap-2">
                  ...
                  >
                    {(inputProps: any) => (
                      <Input {...inputProps} id="cpfCnpj" placeholder="" className="bg-gray-50 border-2 border-gray-200 flex-1" required />
                    )}
                  </InputMask>
                  <Button type="button" onClick={handleBuscarCliente} disabled={searchingCpf || !formData.cpfCnpj} variant="outline" className="shrink-0">
                    {searchingCpf ? <Loader2 className="h-4 w-4 animate-spin" /> : <Search className="h-4 w-4" />}
                  </Button>
                </div>
              </FloatingLabelWrapper>

              <FloatingLabelWrapper label="Nome Completo" htmlFor="nomeCompleto">
                <Input
                  id="nomeCompleto"
              ...
              <div className="grid grid-cols-2 gap-3">
                <FloatingLabelWrapper label="CEP" htmlFor="cep">
                  <InputMask
                    mask="99999-999"
                    value={formData.cep}
                  ...
                  >
                    {(inputProps: any) => (
                      <Input {...inputProps} id="cep" placeholder="" className="bg-gray-50 border-2 border-gray-200" required />
                    )}
                  </InputMask>
                </FloatingLabelWrapper>
                <div />
              ...
              <FloatingLabelWrapper label="Rua" htmlFor="rua">
                <Input
                  id="rua"
                  value={formData.rua}
              ...
              <div className="grid grid-cols-2 gap-3">
                <FloatingLabelWrapper label="Número" htmlFor="numero">
                  <Input
                    id="numero"
                ...
                <FloatingLabelWrapper label="Bairro" htmlFor="bairro">
                  <Input
                    id="bairro"
              ...
              <FloatingLabelWrapper label="Complemento" htmlFor="complemento">
                <Input
                  id="complemento"
              ...
              <div className="grid grid-cols-2 gap-3">
                <FloatingLabelWrapper label="E-mail" htmlFor="email">
                  <Input
                    id="email"
                    type="email"
                ...
                <FloatingLabelWrapper label="Telefone" htmlFor="telefone">
                  <Input
                    id="telefone"
                    type="tel"
              ...
              <div className="flex gap-3">
                <Button type="button" variant="outline" onClick={() => navigate('/solicitacao/veiculo')} className="flex-1 h-12 text-base font-semibold rounded-full">
