...
export default function ProductDetail() {
  ...
  const produto = {
    ...
    preco: 'R$ 1.950,00',
    imagens: [
      'https://via.placeholder.com/600x400?text=Imagem+Principal',
      'https://via.placeholder.com/200x150?text=Thumb+1',
      'https://via.placeholder.com/200x150?text=Thumb+2',
      'https://via.placeholder.com/200x150?text=Thumb+3'
    ]
  };

  const caracteristicas = [
    { titulo: 'Capacidade', valor: '15.000 litros' },
    { titulo: 'Material', valor: 'Aço inoxidável AISI 304' },
    { titulo: 'Espessura', valor: '4,76mm' },
    { titulo: 'Compartimentos', valor: '4 compartimentos' },
    { titulo: 'Sistema de Descarga', valor: 'Bomba centrífuga 3"' },
    { titulo: 'Válvulas', valor: 'Válvulas de fundo API' },
    { titulo: 'Certificação', valor: 'INMETRO e ANTT' },
    { titulo: 'Garantia', valor: '12 meses' },
    { titulo: 'Instalação', valor: 'Incluída' }
  ];
      ...
      <section className="relative bg-black text-white py-20 px-6">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <h1 className="text-5xl font-bold mb-4">
            <span className="text-chekauto-yellow">Resolva seu RENAVE/BIN com tranquilidade.</span>
            <br />
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="bg-gray-100 rounded-lg aspect-square flex items-center justify-center cursor-pointer hover:ring-2 hover:ring-chekauto-yellow transition-all">
          ...
          <div>
            ...
            <Button 
              ...
              className="w-full bg-chekauto-yellow text-black hover:bg-chekauto-yellow/90 h-14 text-lg font-bold rounded-full mb-6"
            >
              CONTRATAR SOLUÇÃO
            </Button>
          ...
          <Tabs defaultValue="caracteristicas" className="w-full">
            <TabsList className="w-full justify-start border-b bg-transparent h-auto p-0 space-x-8">
              <TabsTrigger 
                ...
                className="data-[state=active]:border-b-2 data-[state=active]:border-chekauto-yellow rounded-none pb-3 px-0 bg-transparent"
              >
                CARACTERÍSTICAS
              </TabsTrigger>
              <TabsTrigger 
